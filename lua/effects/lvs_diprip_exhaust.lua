...
function EFFECT:Init( data )
	...
	particle:SetDieTime( (math.max((1.4 - temp) - Ent:GetVelocity():LengthSqr() * 0.0001,0.2) + Scale * math.Rand(0.8,1.2)) * math.Rand(0.25,0.5) )
	particle:SetAirResistance( 400 ) 
	particle:SetStartAlpha( (100 - 50 * temp + Scale * 150) * 0.25 )
	particle:SetStartSize( 2 + (throttle + Scale) * 4 )
	particle:SetEndSize( (10 + 35 * (throttle + Scale)) * 0.75 )
